...
member1 = MoviesLibrary("Samiksha")
...
'''Output'''
"""Inception has been borrowed by hritik
The Matrix is not available in the library
hritik has borrowed: ['Inception']
Inception has been returned to the library by hritik
Titanic was not borrowed by hritik
hritik has borrowed: []"""
